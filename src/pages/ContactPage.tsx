...
export default function ContactPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact &amp; Intake | Ageless Living™ — BC Wellness Centre</title>
        <meta
          name="description"
          content="Start your Ageless Living™ journey. Complete our intake form and our Langley, Victoria, or Kelowna team will be in touch within one business day."
        />
      </Helmet>
